...
public class TranqlDataSource
		implements javax.sql.DataSource, javax.naming.Referenceable, jakarta.resource.Referenceable {
	...
	public TranqlDataSource(ManagedConnectionFactory mcf, ConnectionManager connectionManager) {
		...
		containerRequestInfo = new UserPasswordHandleFactoryRequestInfo<Connection, ConnectionHandle>(handleFactory,
				null, null);
	}
	...
	public Connection getConnection(String user, String password) throws SQLException {
		try {
			UserPasswordHandleFactoryRequestInfo<Connection, ConnectionHandle> cri = new UserPasswordHandleFactoryRequestInfo<Connection, ConnectionHandle>(
					handleFactory, user, password);
	...
	private static class HandleFactory implements DissociatableConnectionHandleFactory<Connection, ConnectionHandle> {
		...
		public DissociatableConnectionHandle<Connection, ConnectionHandle> newHandle(
